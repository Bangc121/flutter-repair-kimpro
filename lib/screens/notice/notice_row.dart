...
import 'package:kimpro/widgets/bottom_icon_button.dart';
import 'package:kimpro/widgets/round_icon_button.dart';

class NoticeRow extends StatelessWidget {
  const NoticeRow({Key? key, required this.user}) : super(key: key);
